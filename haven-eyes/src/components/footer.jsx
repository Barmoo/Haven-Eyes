      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center md:text-left">
          <div className="flex flex-col items-center md:items-start">
            <h4 className="text-lg md:text-xl font-bold mb-3">Browse</h4>
          ...
          <div className="flex flex-col items-center md:items-start">
            <h4 className="text-lg md:text-xl font-bold mb-3">Eye & ear health</h4>
            <ul className="list-none m-0 p-0 space-y-2">
              <li>Eye health</li>
              <li>Ear health</li>
          ...
          <div className="flex flex-col items-center md:items-start">
            <h4 className="text-lg md:text-xl font-bold mb-3">About</h4>
            <ul className="list-none m-0 p-0 space-y-2">
        ...
        <div className="mt-8 flex items-center justify-center md:justify-center gap-4">
          ...
          <a
            ...
            className="p-2 rounded text-gray-500 hover:text-black"
          >
            {/* Facebook SVG */}
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" role="img" aria-hidden="true">
